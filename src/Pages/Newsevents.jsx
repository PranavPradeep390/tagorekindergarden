...
function Newsevents() {
  ...
  return (
   ...
   <h1 
    className='text-4xl md:text-6xl uppercase font-extrabold mb-2 md:mb-4 text-white font_fredoka' >News & Events
    </h1>
  
    <h1
    className='text-xl p-3 bg-yellow-600 rounded-xl text-white font_fredoka '><b>Home - News & Events</b>
    </h1>
    </div>
